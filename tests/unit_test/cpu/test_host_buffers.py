...
the failure surfaces late — Qwen3-ASR reached it only after a full prefill, as a
500 from the transcription endpoint. These drive the shared helper directly so
the contract is checked without standing a model up.
"""
